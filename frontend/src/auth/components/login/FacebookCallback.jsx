    ...
    const handleFacebookCallback = async () => {
      try {
        ...
        if (error) {
          ...
          navigate('/login?error=facebook_auth_failed', { replace: true });
          return;
        }

        if (!data) {
          console.error('No data received from Facebook callback');
        ...
        if (!token || !user) {
          console.error('Invalid data received from Facebook callback');
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-white text-lg">Processing Facebook authentication...</p>
