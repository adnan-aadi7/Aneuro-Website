  ...
  return (
    <header className="bg-[#16161C] text-white px-6 py-5 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        {/* Profile Icon */}
        <button className="p-3  hover:bg-gray-700  transition-colors border border-gray-400 cursor-pointer">
          <User className="text-gray-300 w-3 h-3 lg:w-5 lg:h-5" />
        </button>

        {/* Notification Bell with badge */}
        <button className="p-3  transition-colors relative border border-gray-400 hover:bg-gray-700 cursor-pointer">
        ...
        {/* Add Admin Button */}
        <button className="p-3  hover:bg-gray-700 text-white text-sm font-medium  border border-gray-400 transition-colors cursor-pointer">
          Add Admin
        </button>
      </div>
    </header>
