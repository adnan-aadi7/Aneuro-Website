...
const DetailsChart = () => (
  <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full mt-8 md:mt-15 bg-[#2A2A39] p-4 md:p-8">
    {/* Left: Legend and Table */}
    <div className="flex-1 min-w-[220px] md:min-w-[320px] max-w-lg">
      {/* Legend */}
      ...
      {/* Table */}
      <table className="w-full text-left mt-2 md:mt-4">
        <thead>
          <tr className="text-gray-200 text-base md:text-lg">
            <th className="py-2 md:py-3 font-medium">Brain Type</th>
            <th className="py-2 md:py-3 font-medium">Percentage%</th>
          </tr>
        </thead>
        <tbody>
          {tableRows.map((row) => (
            ...
            >
              <td className="py-3 md:py-5 text-white text-base md:text-lg font-normal">
                {row.type}
              </td>
              <td className="py-3 md:py-5 text-white text-base md:text-lg font-bold">
                {row.percent}%
              </td>
            </tr>
          ))}
    ...
    {/* Right: Bar Chart */}
    <div className="flex-1 min-w-[220px] md:min-w-[320px] flex items-center justify-center h-[260px] md:h-[340px]">
