...
export default function CreateNewPassword({ open, onClose, onReset }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="relative bg-[#232432] shadow-lg w-[450px] max-w-lg p-10 flex flex-col items-center justify-center">
        ...
        <input
          type="password"
          className="w-full mb-4 px-4 py-2 rounded bg-[#232432] border border-slate-600 text-white focus:outline-none focus:border-cyan-400 placeholder-slate-400"
