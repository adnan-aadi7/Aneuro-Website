...
import { Zap, Users, BarChart, Calendar, Star, Gauge } from "lucide-react";
import { useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import {
  fetchPromptPackStats,
  selectPromptPackStats,
    ...
    <div className="lg:p-6 p-2">
      ...
      <div className="flex flex-row items-center justify-between mb-6 flex-wrap gap-2">
        ...
        <button
          ...
          onClick={() =>
            navigate(`/admin/CMS?tab=${encodeURIComponent("Prompt Packs")}`)
          }
        >
          View Details
        </button>
      ...
      <div className="flex flex-wrap gap-6">
        ...
        <div className="bg-[#2A2A39] border border-[#3A3A4A] rounded p-6 min-w-[200px] flex-1">
          ...
          <div className="text-xs text-green-400 font-medium flex items-center gap-1">
            ...
            {overall.totalPacks || 0} total packs
          </div>
        </div>
        ...
        <div className="bg-[#2A2A39] border border-[#3A3A4A] rounded p-6 min-w-[200px] flex-1">
          ...
          <div className="text-white text-3xl font-bold mb-1">
            {overall.avgRating
              ? `${overall.avgRating.toFixed(1)}/5.0`
              : "0.0/5.0"}
          </div>
          <div className="text-xs text-cyan-400 font-medium">
