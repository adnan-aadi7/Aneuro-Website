...
import { fetchEmailCategories } from "../../../../store/Slice/EmailSequenceSLice";
import { 
  createPromptPack,
...
const MannualPrompt = () => {
  ...
  const [brainType] = useState("Architect"); // default prompt type
  ...
  const handleSend = () => {
    ...
    dispatch(createPromptPack(payload));
  };
