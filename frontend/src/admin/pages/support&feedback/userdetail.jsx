...
const editorRef = useRef(null);
  ...
  return (
    <div className="text-white">
      <div>
        <h1 className="text-2xl font-semibold inline-block pb-1">Support Center</h1>
        <p className="text-sm text-gray-400 mt-1">Let's make the day productive</p>
      </div>
        ...
        <div className="p-6 rounded-md mb-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <select className="bg-transparent border border-gray-600 px-4 py-2 rounded-md text-sm outline-none">
              ...
              {activeTab === 'open' && (
                <button
                  ...
                  className="bg-transparent cursor-pointer border border-gray-600 px-4 py-2 text-sm rounded-md font-medium"
                >
                  Reply To This
                </button>
              )}
