  ...
  return (
    <div className=" relative overflow-hidden py-8">
      ...
      <div className="relative z-10  flex flex-col items-center justify-center px-4">
        ...
        {/* Feature Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-2xl mx-auto h-[180px]">
          {/* Card 1 */}
          <div className="bg-black/40 backdrop-blur-sm rounded-lg p-6 text-center hover:bg-black/60 transition-all duration-300 relative overflow-hidden">
